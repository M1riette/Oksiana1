...
// Une fois toutes les questions répondues, l'utilisateur est redirigé vers f1.html ou f2.html en fonction du plus grand nombre de réponses.
...
function enregistrerReponse(reponse, questionId) {
	...
	if (compteurOui + compteurNon === nombreTotalQuestions) { // Vérifie si toutes les questions ont une réponse
		if (compteurOui > compteurNon) {
			window.location.href = "../../../fins/f5.html"; // Redirige vers oui.html si plus de Oui
		} else {
			window.location.href = "../../../fins/f6.html"; // Redirige vers non.html si plus de Non
		}
	}
}